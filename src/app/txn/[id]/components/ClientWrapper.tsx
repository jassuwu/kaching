...
export default function ClientWrapper({ children, transaction }: WrapperProps) {
  ...
  return (
    <>
      <section className="h-full bg-black w-full flex flex-col justify-between items-center">
      ...
      <footer className="z-20 h-[8%] bg-black w-full shadow-defaultBackdrop flex justify-center items-center absolute bottom-0">
